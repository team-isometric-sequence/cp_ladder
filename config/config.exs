...
config :cp_ladder,
  ecto_repos: [CpLadder.Repo]

# Configures the endpoint
config :cp_ladder, CpLadderWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [view: CpLadderWeb.ErrorView, accepts: ~w(html json), layout: false],
  pubsub_server: CpLadder.PubSub,
  live_view: [signing_salt: "1EqX2Xau"]
